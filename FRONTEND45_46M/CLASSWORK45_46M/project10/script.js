...
// ["Столица Германии", "Столица Кыргызстана"]
// Создаем теги h5
...
// Задача. Каждому тегу 'a' задать название ссылки из свойства name, и значение атрибута href взять из свойства link.
...
// <a>Google</a>
// У первого тега a должно быть в атрибуте href значение свойства link 1го элемента массива links
...
/*
    getAttribute('href') - метод, который позволяет получить значение атрибута с переданным в названии параметром
...
// console.log(img.getAttribute('src')) //получили ./cat.jpeg
img.setAttribute('src', './img1.jpeg'); // меняем img на img1 в коде
*/
//
...
for(let i = 0; i < images.length; i++) {
    images[i].setAttribute('src', './img.jpeg')
}
